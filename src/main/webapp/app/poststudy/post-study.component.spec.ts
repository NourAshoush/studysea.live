...
describe('Study Component', () => {
  let comp: PostStudyComponent;
  let fixture: ComponentFixture<PostStudyComponent>;
  ...
  beforeEach(waitForAsync(() => {
    TestBed.configureTestingModule({
      ...
      .overrideTemplate(PostStudyComponent, '')
      .compileComponents();
  }));

  beforeEach(() => {
    fixture = TestBed.createComponent(PostStudyComponent);
