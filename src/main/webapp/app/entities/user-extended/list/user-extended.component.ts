...
import { EntityArrayResponseType, UserExtendedService } from '../service/user-extended.service';
...
export class UserExtendedComponent implements OnInit {
  ...
  trackId = (_index: number, item: IUserExtended): number => this.userExtendedService.getUserExtendedIdentifier(item);
  ...
  protected onResponseSuccess(response: EntityArrayResponseType): void {
    ...
    this.userExtendeds = this.refineData(dataFromBody);
  }

  protected refineData(data: IUserExtended[]): IUserExtended[] {
    return data.sort(this.sortService.startSort(this.predicate, this.ascending ? 1 : -1));
  }

  protected fillComponentAttributesFromResponseBody(data: IUserExtended[] | null): IUserExtended[] {
    return data ?? [];
  }
  ...
  protected queryBackend(predicate?: string, ascending?: boolean): Observable<EntityArrayResponseType> {
    ...
    return this.userExtendedService.query(queryObject).pipe(tap(() => (this.isLoading = false)));
  }
