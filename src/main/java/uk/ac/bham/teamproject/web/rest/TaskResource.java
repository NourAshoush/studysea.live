...
import uk.ac.bham.teamproject.service.TaskQueryService;
import uk.ac.bham.teamproject.service.TaskService;
import uk.ac.bham.teamproject.service.criteria.TaskCriteria;
import uk.ac.bham.teamproject.web.rest.errors.BadRequestAlertException;

/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Task}.
 */
@RestController
@RequestMapping("/api")
public class TaskResource {
    ...
    @GetMapping("/tasks/getTasksList/{id}")
    public ResponseEntity<List<Task>> getTasksList(@PathVariable UserExtended id) {
        log.debug("REST request to get Tasks by User: ");
        List<Task> tasks = taskRepository.tasksList(id);
