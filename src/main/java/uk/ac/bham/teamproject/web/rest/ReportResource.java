...
/**
 * REST controller for managing {@link uk.ac.bham.teamproject.domain.Report}.
 */
@RestController
@RequestMapping("/api")
@Transactional
public class ReportResource {
    ...
    public ResponseEntity<Report> partialUpdateReport(
        ...
        Optional<Report> result = reportRepository
            ...
            .map(existingReport -> {
                if (report.getContentType() != null) {
                    existingReport.setContentType(report.getContentType());
                }
                if (report.getContentID() != null) {
                    existingReport.setContentID(report.getContentID());
                }
                if (report.getContentAuthor() != null) {
                    existingReport.setContentAuthor(report.getContentAuthor());
                }
                if (report.getReportedBy() != null) {
                    existingReport.setReportedBy(report.getReportedBy());
                }
                if (report.getReportedTime() != null) {
                    existingReport.setReportedTime(report.getReportedTime());
                }
                if (report.getReportedReason() != null) {
                    existingReport.setReportedReason(report.getReportedReason());
                }
