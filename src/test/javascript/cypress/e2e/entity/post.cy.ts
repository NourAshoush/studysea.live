...
describe('Post e2e test', () => {
  ...
  describe('Post page', () => {
    ...
    describe('with existing value', () => {
      ...
      it.skip('edit button click should load edit Post page and save', () => {
        cy.get(entityEditButtonSelector).first().click();
        cy.getEntityCreateUpdateHeading('Post');
  ...
  describe('new Post page', () => {
    ...
    it('should create an instance of Post', () => {
      cy.get(`[data-cy="createdBy"]`).type('pink').should('have.value', 'pink');

      cy.get(`[data-cy="creationTime"]`).type('2023-03-10T03:17').blur().should('have.value', '2023-03-10T03:17');

      cy.get(`[data-cy="title"]`).type('Associate programming transmitter').should('have.value', 'Associate programming transmitter');
      ...
      cy.get(`[data-cy="likes"]`).type('37155').should('have.value', '37155');

      cy.get(`[data-cy="likedBy"]`)
        .type('../fake-data/blob/hipster.txt')
        .invoke('val')
        .should('match', new RegExp('../fake-data/blob/hipster.txt'));
