...
describe('Comment e2e test', () => {
  ...
  describe('new Comment page', () => {
    ...
    it('should create an instance of Comment', () => {
      ...
      cy.get(`[data-cy="author"]`).type('Shoals eyeballs').should('have.value', 'Shoals eyeballs');

      cy.get(`[data-cy="postID"]`).type('Shoes').should('have.value', 'Shoes');

      cy.get(`[data-cy="creationTime"]`).type('2023-04-08T15:48').blur().should('have.value', '2023-04-08T15:48');
